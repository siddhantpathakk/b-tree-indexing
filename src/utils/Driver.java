...
public class Driver {
    ...
    public static void runExperiments(Database Database, int invalidDataCount, BPlusTree BPTree) {
        ...
        try {
            ...
            experiment3(Database, BPTree);
            System.out.println("---------------------------------------------------");
            TimeUnit.SECONDS.sleep(1);

            experiment4(Database, BPTree);
            TimeUnit.SECONDS.sleep(1);
            System.out.println("---------------------------------------------------");

            experiment5(Database, BPTree);
    ...
    public static void experiment3(Database Database, BPlusTree BPTree) {
        ...
        if (addresses != null) {
            for (Address address : addresses) {
                Record record = Database.getRecord(address);
                result.add(record);
        ...
        System.out.printf("\nNumber of data blocks accessed by process: %d", Database.getBlockAccesses());
        ...
        int blockAccesses = Database.bruteForceSearch(500, 500);
    ...
    public static void experiment5(Database storage, BPlusTree BPTree) {
